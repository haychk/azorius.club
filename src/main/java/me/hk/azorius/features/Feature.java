...
public class Feature
    ...
    public TextManager renderer = Azorius.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof AzoriusGui) {
            AzoriusGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
